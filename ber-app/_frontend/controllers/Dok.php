...
class Dok extends CI_Controller {
	...
	{
		$data['deskripsi']="Dokumen Diskominfo Kab. Tanjung Jabung Timur - ".$this->M_data->titlesistem(1);
		$data['judulapp']="Dokumen Diskominfo Kab. Tanjung Jabung Timur | ".$this->M_data->titlesistem(1);
		$data['judulan']="Dokumen Diskominfo Kab. Tanjung Jabung Timur";
